...
#define bg_bn_gfxTilesLen 7136
extern const bn::tile bg_bn_gfxTiles[223];
...
namespace bn::regular_bg_items
{
    constexpr inline regular_bg_item bg(
            regular_bg_tiles_item(span<const tile>(bg_bn_gfxTiles, 223), bpp_mode::BPP_4, compression_type::NONE), 
